...
<head>
  ...
  <title>Commentaire - I.sAunny</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarAccueil">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-4 text-center">
          <li class="nav-item">
            <a class="nav-link active text-white fw-semibold" href="#">Dashboard</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-semibold" href="#">Membres</a>
          </li>
          <li class="nav-item">
        ...
        <div class="text-center">
          <a href="/ISAUNNY/public/authentificator/logout.php" class="btn btn-danger fw-bold px-4 logout-btn">Déconnexion</a>
        </div>
      </div>
    </div>
  </nav>
